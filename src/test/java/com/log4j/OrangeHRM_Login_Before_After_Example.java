...
public class OrangeHRM_Login_Before_After_Example {
	...
	public void LaunchBrowser() {
		LogMessage.startLog("Chrome Browser Launched");
	...
	public void CloseBrowser() {
		...
		driver.quit();
		LogMessage.endLog("Chrome Browser closed successfully");
	}

	@Test
	public void LoginToOrangeHRM() throws InterruptedException {
		LogMessage.debug("OpenHRM URL Lauched");
		...
		Thread.sleep(3000);
		LogMessage.debug("User Clicked on Logout button");
